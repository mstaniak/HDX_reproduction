...
ggsave("./Figures/hdx_true_probs_smallcl.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)
plot_true_probs_in_time(dataset2_probs_by_time)
ggsave("./Figures/hdx_true_probs_medcl.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)
plot_true_probs_in_time(dataset3_probs_by_time)
ggsave("./Figures/hdx_true_probs_shortsegm.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)

plot_expected_spectra(dataset1_expected_spectra)
ggsave("./Figures/simulated_spectra_smallcl.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)
plot_expected_spectra(dataset2_expected_spectra)
ggsave("./Figures/simulated_spectra_medcl.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)
plot_expected_spectra(dataset3_expected_spectra)
ggsave("./Figures/simulated_spectra_shortsegm.png", device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 300)
